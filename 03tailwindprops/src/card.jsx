...
// export function Card(props){    // default syntax to use props, we have another one here
export function Card({username , btnText ='Visit me'}){
console.log(username);         // props dosen't take array as array=[1,2,3,4 ] and not as onj={arr:'manan'}
